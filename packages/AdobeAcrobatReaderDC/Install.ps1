...
<#
    ...
    .DESCRIPTION
        ...
        Disables auto-updates and suppresses upsell messages.
...
try {
    ...
    $Arguments = "/sAll /rs /rps /msi EULA_ACCEPT=YES ENABLE_CHROMEEXT=0 DISABLE_BROWSER_INTEGRATION=1 ENABLE_OPTIMIZATION=YES DISABLEDESKTOPSHORTCUT=1 /log `"$LogPath\$AppName-MSI.log`""
